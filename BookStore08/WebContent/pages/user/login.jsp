...
<form action="UserServlet" method="get">
	...
	用户名：<input type="text" name="username" value="${requestScope.username}<%-- <%=request.getParameter("username")==null?"":request.getParameter("username") %> --%>"/><br/>
	密码：<input type="password" name="password"/><br/>
	<input type="submit" value="登录"/>
</form>
<div><a href="pages/user/regist.jsp">立即注册</a></div>
